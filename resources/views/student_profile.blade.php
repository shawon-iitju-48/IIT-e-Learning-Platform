        ...
        <form action="{{ url('/') }}/profile/data" method="post" enctype="multipart/form-data">
            ...
            <div class="profilecard">
                ...
                <div class="box">
                    <div class="input-group mb-3">
                        {{-- <span class="input-group-text" id="basic-addon1">Email</span> --}}
                        <input name="skills" type="text" class="form-control" value="{{ $Profileinfo[0]->skills }}"
                            placeholder="Update your skills [comma seperated]" aria-label="Username"
            ...
            <div class="profilecard">
                ...
                <div class="box">
                    <div class="input-group mb-3">
                        {{-- <span class="input-group-text" id="basic-addon1">Email</span> --}}
                        <input name="hall" type="text" class="form-control" value="{{ $Profileinfo[0]->hall }}"
                            placeholder="Update your hall" aria-label="Username" aria-describedby="basic-addon1">
                    </div>
