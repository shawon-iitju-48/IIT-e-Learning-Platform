                    ...
                    <div class="card bg-comman w-100">
                        <div class="card-body">
                            <div class="db-widgets d-flex justify-content-between align-items-center">
                                <div class="db-info">
                                    <h6>Total Courses</h6>
                                    <h3>{{ $DashInfo[0][0]->totalcourse }}</h3>
                                </div>
                                <div class="db-icon">
                        ...
                        <div class="card-body">
                            <div class="db-widgets d-flex justify-content-between align-items-center">
                                <div class="db-info">
                                    ...
                                    <h3>{{ $DashInfo[0][0]->totalcourse - $DashInfo[1][0]->inprogress }}</h3>
                                </div>
                                <div class="db-icon">
                        ...
                        <div class="card-body">
                            <div class="db-widgets d-flex justify-content-between align-items-center">
                                <div class="db-info">
                                    ...
                                    <h3>{{ $DashInfo[2][0]->ongoingexam }}</h3>
                                </div>
                                <div class="db-icon">
                                ...
                                <div class="row">
                                    <div id="cstatus" class="col-lg-3 col-md-3 dash-widget1">
                                        <div class="circle-bar circle-bar2">
                                            <div class="circle-graph2" data-percent="{{ $DashInfo[3][0]->cstatus }}">
                                                <b>{{ $DashInfo[3][0]->cstatus }}%</b>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="dash-details">
                                            <div class="lesson-activity">
                                                ...
                                                <div class="views-lesson">
                                                    <h5>Course Code</h5>
                                                    <h4 id="cid">ICT-{{ $DashInfo[3][0]->c_id }}</h4>
                                                </div>
                                            </div>
                                            <div class="lesson-activity">
                                                <div class="lesson-imgs">
                                                ...
                                                <div class="views-lesson">
                                                    <h5>Course Title</h5>
                                                    <h4 id="cname">{{ $DashInfo[3][0]->cname }}</h4>
                                                </div>
                                            </div>
                                            ...
                                            <div class="lesson-activity">
                                                ...
                                                <div class="views-lesson">
                                                    <h5>Semester</h5>
                                                    <h4 id="sname">{{ $DashInfo[3][0]->sname }}</h4>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-3 col-md-3">
                                        <div class="dash-details">
                                            ...
                                            <div class="lesson-activity">
                                                ...
                                                <div class="views-lesson">
                                                    <h5>Batch</h5>
                                                    <h4 id="ee">{{$DashInfo[3][0]->batch}}</h4>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-3 col-md-3 d-flex align-items-center justify-content-center">
                                        <div class="skip-group">
                                            ...
                                            <button id="{{ $DashInfo[3][0]->c_id }}_{{ $DashInfo[3][0]->batch }}" class="btn btn-info continue-btn gotoclassroom">Continue</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                                    ...
                                                    <li class="feed-item d-flex align-items-center">
                                                        <div class="dolor-activity">
                                                            ...
                                                            <ul class="teacher-date-list">
                                                                ...
                                                                <li>|</li>
                                                                <li><i class="fas fa-clock me-2"></i>{{ $item->sname }} |
                                                                    {{ $item->batch }} batch</li>
                                                            </ul>
                                                        </div>
